...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.image_upload_info_icon = Image(page, '{identifier}-image-upload-widget-info-icon', 'Info icon')
        self.image_upload_info_title = Text(page, '{identifier}-image-upload-widget-info-title-text', 'Info text')
        ...
        self.upload_input = FileInput(page, '{identifier}-image-upload-widget-input', 'Input file')
