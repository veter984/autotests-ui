...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.title_input = Input(page,'create-course-form-title-input','Title')#.locator('input')
        self.estimated_time_input = Input(page,'create-course-form-estimated-time-input', 'Time')#.locator('input')
        self.description_textarea = Textarea(page, 'create-course-form-description-input', 'Description')#.locator(
            #'textarea').first

        self.max_score_input = Input(page,'create-course-form-max-score-input', 'Max score')#.locator('input')
        self.min_score_input = Input(page, 'create-course-form-min-score-input', 'Min score')#.locator('input')
